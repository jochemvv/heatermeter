...
public class TestConfiguration {
    ...
    public TestTemperatureSensor channel0() {
        return new TestTemperatureSensor("channel0", true);
    }

    @Bean(name = "channel1")
    public TestTemperatureSensor channel1() {
        return new TestTemperatureSensor("channel1", false);
    }

    @Bean(name = "channel2")
    public TestTemperatureSensor channel2() {
        return new TestTemperatureSensor("channel2", false);
    }

    @Bean(name = "channel3")
    public TestTemperatureSensor channel3() {
        return new TestTemperatureSensor("channel3", true);
    }
